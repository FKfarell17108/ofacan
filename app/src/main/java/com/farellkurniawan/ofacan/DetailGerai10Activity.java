...
public class DetailGerai10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_gerai10);

        btninccard1 = findViewById(R.id.btn_inc_card_1_gerai_10_dtl);
        btndeccard1 = findViewById(R.id.btn_dec_card_1_gerai_10_dtl);
        tvdisplaycard1 = findViewById(R.id.tv_dislpay_card_1_gerai_10_dtl);

        btninccard2 = findViewById(R.id.btn_inc_card_2_gerai_10_dtl);
        btndeccard2 = findViewById(R.id.btn_dec_card_2_gerai_10_dtl);
        tvdisplaycard2 = findViewById(R.id.tv_dislpay_card_2_gerai_10_dtl);

        btninccard3 = findViewById(R.id.btn_inc_card_3_gerai_10_dtl);
        btndeccard3 = findViewById(R.id.btn_dec_card_3_gerai_10_dtl);
        tvdisplaycard3 = findViewById(R.id.tv_dislpay_card_3_gerai_10_dtl);

        btninccard4 = findViewById(R.id.btn_inc_card_4_gerai_10_dtl);
        btndeccard4 = findViewById(R.id.btn_dec_card_4_gerai_10_dtl);
        tvdisplaycard4 = findViewById(R.id.tv_dislpay_card_4_gerai_10_dtl);

        btninccard5 = findViewById(R.id.btn_inc_card_5_gerai_10_dtl);
        btndeccard5 = findViewById(R.id.btn_dec_card_5_gerai_10_dtl);
        tvdisplaycard5 = findViewById(R.id.tv_dislpay_card_5_gerai_10_dtl);

        btninccard6 = findViewById(R.id.btn_inc_card_6_gerai_10_dtl);
        btndeccard6 = findViewById(R.id.btn_dec_card_6_gerai_10_dtl);
        tvdisplaycard6 = findViewById(R.id.tv_dislpay_card_6_gerai_10_dtl);

        btninccard7 = findViewById(R.id.btn_inc_card_7_gerai_10_dtl);
        btndeccard7 = findViewById(R.id.btn_dec_card_7_gerai_10_dtl);
        tvdisplaycard7 = findViewById(R.id.tv_dislpay_card_7_gerai_10_dtl);

        btninccard8 = findViewById(R.id.btn_inc_card_8_gerai_10_dtl);
        btndeccard8 = findViewById(R.id.btn_dec_card_8_gerai_10_dtl);
        tvdisplaycard8 = findViewById(R.id.tv_dislpay_card_8_gerai_10_dtl);
