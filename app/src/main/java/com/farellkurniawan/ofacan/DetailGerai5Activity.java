...
public class DetailGerai5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_gerai5);

        btninccard1 = findViewById(R.id.btn_inc_card_1_gerai_5_dtl);
        btndeccard1 = findViewById(R.id.btn_dec_card_1_gerai_5_dtl);
        tvdisplaycard1 = findViewById(R.id.tv_dislpay_card_1_gerai_5_dtl);

        btninccard2 = findViewById(R.id.btn_inc_card_2_gerai_5_dtl);
        btndeccard2 = findViewById(R.id.btn_dec_card_2_gerai_5_dtl);
        tvdisplaycard2 = findViewById(R.id.tv_dislpay_card_2_gerai_5_dtl);

        btninccard3 = findViewById(R.id.btn_inc_card_3_gerai_5_dtl);
        btndeccard3 = findViewById(R.id.btn_dec_card_3_gerai_5_dtl);
        tvdisplaycard3 = findViewById(R.id.tv_dislpay_card_3_gerai_5_dtl);

        btninccard4 = findViewById(R.id.btn_inc_card_4_gerai_5_dtl);
        btndeccard4 = findViewById(R.id.btn_dec_card_4_gerai_5_dtl);
        tvdisplaycard4 = findViewById(R.id.tv_dislpay_card_4_gerai_5_dtl);

        btninccard5 = findViewById(R.id.btn_inc_card_5_gerai_5_dtl);
        btndeccard5 = findViewById(R.id.btn_dec_card_5_gerai_5_dtl);
        tvdisplaycard5 = findViewById(R.id.tv_dislpay_card_5_gerai_5_dtl);

        btninccard6 = findViewById(R.id.btn_inc_card_6_gerai_5_dtl);
        btndeccard6 = findViewById(R.id.btn_dec_card_6_gerai_5_dtl);
        tvdisplaycard6 = findViewById(R.id.tv_dislpay_card_6_gerai_5_dtl);

        btninccard7 = findViewById(R.id.btn_inc_card_7_gerai_5_dtl);
        btndeccard7 = findViewById(R.id.btn_dec_card_7_gerai_5_dtl);
        tvdisplaycard7 = findViewById(R.id.tv_dislpay_card_7_gerai_5_dtl);

        btninccard8 = findViewById(R.id.btn_inc_card_8_gerai_5_dtl);
        btndeccard8 = findViewById(R.id.btn_dec_card_8_gerai_5_dtl);
        tvdisplaycard8 = findViewById(R.id.tv_dislpay_card_8_gerai_5_dtl);
